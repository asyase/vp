...
if (isset($_POST['message_reply_submit'])) {
  if (!empty($_POST['message_text'])) {
    $notice = sendmessagereply($_GET['id'], $_POST['message_text']);
  }
}
?>
<!DOCTYPE html>
<html>
  ...
  <body>
    ...
    <table border="1" width="50%">
      <?php echo getmessagebyid($_GET['id']); ?>
      <?php echo getmessagesreplies($_GET['id']); ?>
    </table><br><br>
    ...
    <form method="POST">
      ...
      <br><br>
      <input type="submit" name="message_reply_submit" value="Saada">
    </form>
  </body>
</html>
