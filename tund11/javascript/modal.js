...
let captiontext;
let photoid;
let photodir = "../tund10/photoupload_normal/";
    ...
    if(rating>0){
        ...
        webrequest.onreadystatechange = function() {
            if(this.readyState == 4 && this.status == 200){
                //nuud see, mis onnestumise korral tehakse
                document.getElementById("avgRating").innerHTML = "Keskmine hinne: " + this.responseText;
                //uuendab skoori automaatselt ilma lehte uuesti laadimata
